...
_NODES_EN = {
    ...
    "METHOD": {
        "text": "How was the payment made — UPI, NEFT, cash, cheque, or card?",
        "next": {"default": "AMOUNT"},
    },
    "AMOUNT": {
...
_NODES_HI = {
    ...
    "METHOD": {
        "text": "Payment kaise ki — UPI, NEFT, cash, cheque, ya card se?",
        "next": {"default": "AMOUNT"},
    },
    "AMOUNT": {
...
INTRO_LINES_EN = [
    ...
    "You will be asked: payment date, method (UPI/NEFT/cash), and amount.",
...
INTRO_LINES_HI = [
    ...
    "Aapse payment ki tarikh, tarika (UPI/NEFT/cash), aur amount poochi jayegi.",
...
COMMON_ACKS = [
    "Thank you.", "I understand.", "Okay.", "Sure.", "One moment.", "Great.",
    "Shukriya.", "Samajh gaya.", "Theek hai.", "Zaroor.", "Ek minute.", "Bahut achha.",
    # Additional EN acks
    "Got it, thank you.", "Noted.", "Perfect.", "Understood.",
    "Thank you for confirming.", "Thank you for your time.",
    "I see, noted.", "Alright, thank you.",
    # Additional HI acks
    "Dhanyawaad.", "Shukriya batane ke liye.", "Bilkul.", "Haan, samajh gaya.",
    "Theek hai, note kar liya.", "Aapka jawab record ho gaya.",
]

# Build the warm-cache list: current lang node texts + ALL Hindi + ALL English node texts
# This guarantees > 50 unique phrases for both languages
_all_en_texts = [n["text"] for n in _NODES_EN.values()]
_all_hi_texts = [n["text"] for n in _NODES_HI.values()]
_intro_en = " ".join(INTRO_LINES_EN)
_intro_hi = " ".join(INTRO_LINES_HI)
...
def detect_sentiment(text: str) -> str:
    t = text.lower()
    pos = {"paid", r"ho\s*gaya", r"kar\s*diya", "yes", "haan", "bilkul", "shukriya", "great", "good"}
    neg = {"nahi", "nahin", "no", "problem", r"nahi\s*kar", "sorry", "issue", "late"}
